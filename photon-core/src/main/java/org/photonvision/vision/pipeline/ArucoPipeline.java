...
public class ArucoPipeline
        extends CVPipeline<CVPipelineResult, ArucoPipelineSettings> {

    private final RotateImagePipe rotateImagePipe = new RotateImagePipe();
    private final HSVPipe hsvPipe = new HSVPipe();
    private final FindArucosPipe arducsoPipe = new FindArucosPipe();
    ...
    protected CVPipelineResult process(Frame frame, ArucoPipelineSettings settings) {
        ...
        CVPipeResult<List<CVShape>> filterShapeResult = arducsoPipe.run(hsvPipeResult.output);
